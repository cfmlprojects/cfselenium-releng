...
cls
echo.
echo       cfselenium-releng menu
REM echo       usage: cfselenium-releng.bat [start|stop|{target}]
echo.
...
echo to stop the server, run this again or run: cfselenium-releng.bat stop
goto end
::
:stopServer
